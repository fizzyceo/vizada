...
const Consulting = () => {
  ...
  return (
    <div className="min-h-screen w-full relative bg-white ">
      ...
      {/* <div className="sticky w-full flex justify-end px-2 h-fit items-center z-50 left-0 top-1/2 -translate-y-1/2">
        <div className="flex flex-col w-fit gap-4 text-blue-gray-900 justify-center">
          <Typography
            as="a"
