...
const ManagementCard = () => {
  ...
  const InitiatePayment = async () => {
    ...
    if (user && Object.keys(user).length > 0) {
      let body = {
        ...
        items: [
          {
            name: `Management ${activePlan === 1 ? "yearly" : "monthly"}`,
  ...
  return (
    <div className="rounded-xl border-t-[3px] hover:scale-105 transition-all w-[350px] md:w-[350px] border-t-blue-700 p-5 space-y-5 roboto bg-white">
